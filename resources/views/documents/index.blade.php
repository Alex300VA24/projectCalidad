...
@section('content')
    <header class="page-heading reveal">
        <div>
            ...
            <h1>Documentos</h1>
            <p>Consulta documentos institucionales, sílabos organizados por semestre y documentos de calidad.</p>
        </div>
    ...
    <nav class="document-type-nav reveal" aria-label="Tipo de documento">
        <a @class(['active' => $activeType === 'institucional']) href="{{ route('documents.index') }}" @if ($activeType === 'institucional') aria-current="page" @endif>
        ...
        <a @class(['active' => $activeType === 'silabo']) href="{{ route('documents.index', ['tipo' => 'silabo']) }}" @if ($activeType === 'silabo') aria-current="page" @endif>
            ...
            <span><strong>Sílabos por semestre</strong><small>Periodos 2025 y 2026</small></span>
        </a>
    ...
    @if ($activeType === 'silabo')
        <section class="semester-picker panel reveal" aria-labelledby="semester-picker-title">
            <div>
                ...
                <h2 id="semester-picker-title">Selecciona un semestre</h2>
                <p>Los sílabos aparecen después de elegir el periodo académico.</p>
            </div>
        ...
        @if ($activePeriodo !== '')
            <section class="cycle-picker panel reveal" aria-labelledby="cycle-picker-title">
                <div>
                    ...
                    <h2 id="cycle-picker-title">Selecciona un ciclo</h2>
