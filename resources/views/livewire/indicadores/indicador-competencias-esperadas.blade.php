...
<div class="space-y-5">
    <div class="flex flex-wrap items-center justify-between gap-3">
        <a href="{{ route('quality-indicators.dashboard') }}" class="inline-flex min-h-11 items-center gap-1.5 text-sm font-semibold text-[var(--indigo)] transition hover:underline">
